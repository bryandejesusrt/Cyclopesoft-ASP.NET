...
namespace Cyclope
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<Cyclopesoft.DataLayer.Context.CyclopesoftContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
